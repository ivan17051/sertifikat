                                    ...
                                    <table width="80%" cellspacing="0" cellpadding="0" border="1">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="paddingfont" width="15%">Kategori</td>
                                                <td class="paddingfont" width="20%">Deskripsi</td>
                                                <td class="paddingfont" width="20%">Nilai</td>
                                                <td class="paddingfont">Keterangan</td>
                                            </tr>
                                            <tr>
                                                <td class="paddingfont">1.</td>
                                                <td class="paddingfont">Kategori</td>
                                                <td class="paddingfont">Ini adalah deskripsi kategori</td>
                                                <td class="paddingfont">80</td>
                                                <td class="paddingfont">Ini adalah keterangan nilai</td>
                                            </tr>
                                            <tr>
                                                <td class="paddingfont">2.</td>
                                                <td class="paddingfont">Kategori</td>
                                                <td class="paddingfont">Ini adalah deskripsi kategori</td>
                                                <td class="paddingfont">80</td>
                                                <td class="paddingfont">Ini adalah keterangan nilai</td>
